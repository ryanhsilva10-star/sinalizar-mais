    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          O sinal que você procura não está aqui. Vamos voltar para a trilha?
        </p>
        <div className="mt-6">
          <Link
            to="/"
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-full border border-input px-5 py-2.5 text-sm font-bold">
            Início
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SinaLINK — Aprenda LIBRAS brincando" },
      ...
      { name: "author", content: "SinaLINK" },
      { property: "og:title", content: "SinaLINK — Aprenda LIBRAS brincando" },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Baloo+2:wght@600;700;800&family=Nunito:wght@400;600;700;800&family=Space+Grotesk:wght@400;500;600;700&display=swap" },
    ],
  }),
